...
void _ZNSt3__119__shared_weak_count10__add_weakEv(struct ptr *this) {
...
void __cxa_guard_acquire() {
        koops("Calling __cxa_guard_acquire\n");
}

void __cxa_guard_release() {
        koops("Calling __cxa_guard_release\n");
}
...
UNIMPLEMENTED(_ZNKSs4findEPKcmm)
UNIMPLEMENTED(_ZNKSs7compareEPKc)
UNIMPLEMENTED(_ZNSs4_Rep10_M_destroyERKSaIcE)
UNIMPLEMENTED(_ZNSs4_Rep11_S_terminalE)
UNIMPLEMENTED(_ZNSs4_Rep20_S_empty_rep_storageE)
UNIMPLEMENTED(_ZNSs6appendEPKcm)
UNIMPLEMENTED(_ZNSs6appendERKSs)
UNIMPLEMENTED(_ZNSs7reserveEm)
UNIMPLEMENTED(_ZNSs9_M_mutateEmmm)
UNIMPLEMENTED(_ZNSsC1EPKcmRKSaIcE)
UNIMPLEMENTED(_ZNSsC1EPKcRKSaIcE)
UNIMPLEMENTED(_ZNSsC1ERKSs)
//UNIMPLEMENTED(_ZSt11__once_call)
//UNIMPLEMENTED(_ZSt15__once_callable)
UNIMPLEMENTED(_ZSt17__throw_bad_allocv)
UNIMPLEMENTED(_ZSt20__throw_length_errorPKc)
UNIMPLEMENTED(_ZSt20__throw_system_errori)

__thread void* _ZSt15__once_callable;
__thread void (*_ZSt11__once_call)();

/**void
_ZSt16__once_call_implISt12_Bind_simpleIFPFvPvEPNSt15aligned_storageILm32ELm8EE4typeEEEEvv()

{
        kprintf("%s: __once_callable: %p\n", __func__ ,_ZSt15__once_callable);
        halt();
...
__tls_get_addr(tls_index *ti)
{
        ...
        if (tls_data[0] == NULL) {
                tls_data[0] = &_ZSt15__once_callable;
                tls_data[1] = &_ZSt11__once_call;
                kprintf("setting up tls_data 0=%p 1=%p\n", tls_data[0], tls_data[1]);

        }
        
        kprintf("__tls_get_addr(%p, %lx, %lx)\n", ti, ti->ti_module, ti->ti_offset);
        if (tls_data[0] == ti ) {
                kprintf("found address in data[0]\n");
                retval = &tls_data[0];
        }
        if (tls_data[1] == ti ) {
                kprintf("found address in data[1]\n");
                retval = &tls_data[1];
        }
        kprintf("tls_get_addr = %p\n", retval);
        return retval;
        }*/
...
void __once_proxy()
{
        ...
        kprintf("__once_proxy_func() finished");
}

//void *__once_proxy = &__once_proxy_func;
